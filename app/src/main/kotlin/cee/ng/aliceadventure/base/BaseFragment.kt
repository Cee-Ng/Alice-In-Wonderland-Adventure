...
import cee.ng.aliceadventure.AliceadventureApplication
import timber.log.Timber

abstract class BaseFragment<P : BaseContract.Presenter> : Fragment(), BaseContract.View {

    protected val aliceadventureApplication: AliceadventureApplication
        get() = activity.application as AliceadventureApplication
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val configuration = aliceadventureApplication.getPresenterConfiguration()
